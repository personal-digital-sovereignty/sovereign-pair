<template>
  <div class="w-full bg-surface-50 dark:bg-[#050505] border border-surface-200 dark:border-surface-700/50 rounded-xl overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.1)] dark:shadow-[0_0_20px_rgba(0,0,0,0.5)] relative group">
    ...
    <div v-if="commandLog.length > 0" class="border-t border-surface-200 dark:border-surface-800/80 bg-surface-100 dark:bg-[#0a0a0a] p-3 max-h-32 overflow-y-auto custom-scroll">
