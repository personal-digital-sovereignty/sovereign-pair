...
<template>
  <div class="fixed inset-0 flex w-full bg-surface-900 text-slate-200 overflow-hidden font-sans">
    ...
    <nav class="w-14 shrink-0 bg-surface-950 border-r border-slate-800 flex flex-col items-center py-4 z-20">
      ...
      <!-- Vault Button -->
      <router-link to="/vault" class="p-2 mt-2 text-slate-400 hover:text-emerald-400 hover:bg-surface-800 rounded-lg transition-colors" title="Sensus Vault">
      ...
      <!-- Back to Chat Button (Visible only inside Vault or Config) -->
      <router-link to="/" class="p-2 text-slate-400 hover:text-white hover:bg-surface-800 rounded-lg transition-colors mt-auto mb-2" title="Voltar ao Chat">
