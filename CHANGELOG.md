...
## [1.3.0] - 2026-04-23
*Epic: Resilience Shield, Hardware Telemetry, Oracle Cloud Integration & Chat Tool Dispatcher*
...
- **Native Chat Tool Dispatcher**: O Chat regular agora possui suporte nativo a ferramentas (Weather, Finance, Search). Implementado interceptador de streaming em `api.rs` que executa Workers Python (`tokio::spawn`) e injeta resultados em tempo real via SSE, eliminando a dependência de loops de Deep Research para consultas rápidas.
