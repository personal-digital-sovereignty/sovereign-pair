...
| `EMBED_MODEL` | Vetorização Matemática | `nomic-embed-text` | O motor puramente responsável por transmutar texto em um hiper-espaço de 768 dimensões. O modelo de *Embedding* **nunca** deve ser substituído por curiosidade após subir o ChromaDB pela 1ª vez. A troca deforma a coordenada espacial e quebra o banco. |
