...
# =========================================================================
# Sovereign Pair - Local Hardware Ollama Optimization (Cross-Distro)
# Phase 0.01 Local Tuning - Compatível com Arch, Ubuntu, Debian, Fedora
# =========================================================================
...
# =========================================================================
echo "========================================================================="
echo "  Sovereign Pair - Ollama Optimization (Cross-Distro)"
echo "========================================================================="
echo ""

if [ "$EUID" -ne 0 ]; then
    log_error "Por favor, execute este script como root (sudo ./optimize_ollama_ryzen.sh)"
    exit 1
fi
